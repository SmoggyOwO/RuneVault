            ...
            >
              <div>
                {login === "false" ? (
                  ...
                  <div
                    className="flex relative overflow-hidden px-8 py-2.5 rounded-xl border text-black dark:text-white flex justify-center group/modal-btn hover:shadow-md transition-all duration-300 ease-in-out  text-center transition-transform duration-500 text-sm font-medium tracking-wide cursor-pointer"
